...
import 'package:paycom/cores/components/custom_circular_progress_indicator.dart';
        ...
        return Row(
          ...
          children: [
            if (text != null)
              TextWidget(
                text ?? 'no text',
                textColor: textColor ?? kcButtonText,
                fontSize: sp(15),
